...
namespace nep5 
{
    public class Contract1 : SmartContract
    {
        ...
        private static readonly byte[] Owner = "AUxDxtyef3CwYKg38x6kPbP8ZDpwuKt3MQ".ToScriptHash(); //Owner Address
        ...
        [DisplayName("name")]
        public static string Name() => "Beijing Workshop Token"; //name of the token

        [DisplayName("symbol")]
        public static string Symbol() => "BWT"; //symbol of the stoken
