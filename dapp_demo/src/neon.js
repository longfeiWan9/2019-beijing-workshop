...
const CONTRACT_ADDRESS = 'AH2KovB9EUGbxZUyiGrFvbryzdsSVc3rcv';
const CONTRACT_SCRIPTHASH = '84ecd270ddbbe06e1f1ed4c27e22b292dcc9b30d';
const AMOUNT_OF_NEO_TO_BUY_ONE_VOUCHER = 0.1;

const testNetNeoScan = new Neon.api.neoscan.instance("PrivateNet");
